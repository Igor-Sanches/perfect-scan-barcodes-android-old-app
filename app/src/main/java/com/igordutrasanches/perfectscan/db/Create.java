...
public class Create extends SQLiteOpenHelper {
    private static final String TABELA = "scan_create", ID = "rowid", TITLE = "title_create", DATE = "date_create", CODE = "code_create", TYPE = "typ_create", FORMAT = "format_create";

    private final String[] dados = new String[]{ID, TITLE, DATE, CODE, TYPE, FORMAT};

    public Create(Context mContext){
        super(mContext, "IGOR_SANCHES2", null, 3);
    }
